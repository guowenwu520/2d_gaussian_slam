...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def backward(ctx, grad_out_color, grad_radii, grad_depth,grad_n_touched):
        print(f"grad_out_color shape: {grad_out_color.shape}")
        print(f"grad_out_radii shape: {grad_radii.shape}")
        print(f"grad_out_depth shape: {grad_depth.shape}")
        print(f"grad_n_touched shape: {grad_n_touched.shape}")
