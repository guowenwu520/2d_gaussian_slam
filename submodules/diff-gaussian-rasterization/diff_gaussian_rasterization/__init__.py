...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths , opacity, n_touched= _C.rasterize_gaussians(*args)
    ...
    @staticmethod
    def backward(ctx, grad_out_color, _, grad_out_depth,_s,__s):
