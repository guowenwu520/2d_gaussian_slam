...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, is_single_read = True,load_iteration=None, shuffle=True, resolution_scales=[1.0],gradually_read = True,add_extra_images = False):
        ...
        for resolution_scale in resolution_scales:
            ...
            self.train_cameras[resolution_scale] = cameraList_from_camInfos(scene_info.train_cameras, resolution_scale, args, scene_info.is_nerf_synthetic, False,is_single_read)
            print("Loading Test Cameras")
            self.test_cameras[resolution_scale] = cameraList_from_camInfos(scene_info.test_cameras, resolution_scale, args, scene_info.is_nerf_synthetic, True,is_single_read)
