...
# Note
- In an academic paper, please refer to our work as **Gaussian Splatting SLAM** or **RGBD_GS_SLAM** for short (this repo's name) to avoid confusion with other works.
...
## Installation
```
git clone https://github.com/muskie82/RGBD_GS_SLAM.git --recursive
cd RGBD_GS_SLAM
```
...
# License
RGBD_GS_SLAM is released under a **LICENSE.md**. For a list of code dependencies which are not property of the authors of RGBD_GS_SLAM, please check **Dependencies.md**.
